...
const StoryboardPanel: React.FC<StoryboardPanelProps> = ({ panel, index, onClick, aspectRatio = "16:9" }) => {
  return (
    <div className="group relative">
      ...
      >
        <div className={`w-full bg-slate-100 dark:bg-[#111318] overflow-hidden ${aspectRatio === "1:1" ? "aspect-square" : "aspect-video"}`}>
          <img
            src={panel.imageUrl}
